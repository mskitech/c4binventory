<div class="content-wrapper">
    ...
    <section class="content" style="min-height:80vh;">
      <h4 class="m-2">KISENYI BRANCH 1</h4>
      <div class="container-fluid">
        <!-- .row -->
        <div class="row">
            ...
            <div class="info-box bg-danger ">
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    echo number_format($all_customer = $obj->total_count('member'));
                  ?>
                </span>
              </div>
          ...
          <div class="col-xl-3 col-xxl-6 col-sm-6">
            <div class="info-box  bg-success">
              <div class="info-box-content">
                ...
                <span class="info-box-number"> 
                  <?php 
                    echo number_format($all_customer = $obj->total_count('suppliar'));
                  ?>
                </span>
              </div>
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> 
                  <?php  
                      ...
                      echo number_format($total_sell_amount =  $res[0]);
                  ?>
                </span>
              </div>
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"> 
                  <?php  
                      ...
                      $stmt->execute();
                      $res = $stmt->fetch(PDO::FETCH_NUM);
                      echo number_format($total_purchase =  $res[0]);
                  ?>
                </span>
              </div>
