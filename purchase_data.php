...
foreach ($empRecords as $row) {
    $data[] = array(
        ...
        "purchase_quantity" => number_format($row['purchase_quantity']),
        "purchase_price" => number_format($row['purchase_price']),
        "purchase_sell_price" => number_format($row['purchase_sell_price']),
        "purchase_net_total" => number_format($row['purchase_net_total']),
        "purchase_due_bill" => number_format($row['purchase_due_bill']),
